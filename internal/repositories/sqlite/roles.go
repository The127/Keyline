...
func mapRole(role *repositories.Role) *sqliteRole {
	return &sqliteRole{
		sqliteBaseModel: mapBase(role.BaseModel),
...
func (r *sqliteRole) Map() *repositories.Role {
...
func (r *sqliteRole) scan(row sqlitehelpers.Row, additionalPtrs ...any) error {
	ptrs := []any{
		&r.id,
		&r.auditCreatedAt,
		&r.auditUpdatedAt,
