...
type Context struct {
	...
	identityProviders       *sqlite.IdentityProviderRepository
...
func (c *Context) IdentityProviders() repositories.IdentityProviderRepository {
	if c.identityProviders == nil {
		c.identityProviders = sqlite.NewIdentityProviderRepository(c.db, c.changeTracker, db.IdentityProviderEntityType)
	}
