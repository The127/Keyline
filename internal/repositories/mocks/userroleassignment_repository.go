...
// Source: Keyline/repositories (interfaces: UserRoleAssignmentRepository)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/userroleassignment_repository.go -package=mocks Keyline/repositories UserRoleAssignmentRepository
//
