...
type sqliteApplication struct {
	...
	trustedExchangers       sqlitehelpers.StringSlice
}
...
func (a *sqliteApplication) Map() *repositories.Application {
	return repositories.NewApplicationFromDB(
		...
		a.systemApplication,
		sqlitehelpers.UnwrapNullString(a.claimsMappingScript),
...
func (a *sqliteApplication) scan(row sqlitehelpers.Row, additionalPtrs ...any) error {
	ptrs := []any{
