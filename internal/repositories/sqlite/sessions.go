...
func mapSession(session *repositories.Session) *sqliteSession {
	return &sqliteSession{
		sqliteBaseModel: mapBase(session.BaseModel),
...
func (s *sqliteSession) Map() *repositories.Session {
...
func (s *sqliteSession) scan(row sqlitehelpers.Row, additionalPtrs ...any) error {
	ptrs := []any{
		&s.id,
		&s.auditCreatedAt,
		&s.auditUpdatedAt,
