...
func mapApplicationKey(applicationKey *repositories.ApplicationKey) *sqliteApplicationKey {
	return &sqliteApplicationKey{
		sqliteBaseModel: mapBase(applicationKey.BaseModel),
...
func (k *sqliteApplicationKey) Map() *repositories.ApplicationKey {
...
func (k *sqliteApplicationKey) scan(row sqlitehelpers.Row, additionalPtrs ...any) error {
	ptrs := []any{
		&k.id,
		&k.auditCreatedAt,
		&k.auditUpdatedAt,
...
func (r *ApplicationKeyRepository) FirstOrNil(ctx context.Context, filter *repositories.ApplicationKeyFilter) (*repositories.ApplicationKey, error) {
	...
	applicationKey := &sqliteApplicationKey{}
...
func (r *ApplicationKeyRepository) ExecuteInsert(ctx context.Context, tx *sql.Tx, applicationKey *repositories.ApplicationKey) error {
	...
	applicationKey.SetVersion(version)
