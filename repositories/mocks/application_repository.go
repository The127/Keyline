...
// Source: Keyline/repositories (interfaces: ApplicationRepository)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/application_repository.go -package=mocks Keyline/repositories ApplicationRepository
//
...
func (m *MockApplicationRepository) List(ctx context.Context, filter repositories.ApplicationFilter) ([]*repositories.Application, error) {
	m.ctrl.T.Helper()
